...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="assets/img/train-marker.svg" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Stasiun</h1>
            <!-- Icon Divider-->
    ...
    <!-- Map Section-->
    <section class="page-section train" id="train">
        <div class="container">
            <!-- Map Section Heading-->
    ...
    <script>
        ...
        function reload_map(value) {
            ...
            printJSON('train', cityCode).then(data => {
                ...
                if (counter > 0) {
                    document.getElementById('note').innerHTML = `Catatan: Sebanyak ${counter} stasiun tidak mempunyai latitude dan longitude`
                } else {
