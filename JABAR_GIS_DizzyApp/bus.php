...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="assets/img/bus-marker.png" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Terminal</h1>
            <!-- Icon Divider-->
    ...
    <!-- Map Section-->
    <section class="page-section bus" id="bus">
        <div class="container">
            <!-- Map Section Heading-->
    ...
    <script>
        ...
        function reload_map(value) {
            ...
            printJSON('bus', cityCode).then(data => {
                ...
                data.map(function(location, key) {
                    if (location.latitude !== null && location.longitude !== null) {
                        L.marker([location.latitude, location.longitude], {
                            ...
                            .bindPopup(titleCase(location.nama).replace('Gba', 'GBA'))
                    } else {
                        counter++
                    }
                });
                ...
                if (counter > 0) {
                    document.getElementById('note').innerHTML = `Catatan: Sebanyak ${counter} terminal tidak mempunyai latitude dan longitude`
                } else {
